...
const versionData: Version[] = [
  ...
  ...platforms.map((p) => ({
    ...
    size: p.id === 'windows' ? '140 MB' : p.id === 'linux' ? '119 MB' : p.id === 'macos' ? 'N/A' : p.id === 'android' ? '15 MB' : 'N/A',
    sha256: p.id === 'windows' ? '5911a6b74fd4332f10c3c59655d84583f101fa4bb627f1a10ac48a93ebd70743' : p.id === 'linux' ? '08064325d73a6f9566bf7b16b89b78f9e9002424b9dfd15b34f3cff5dd4b1214' : p.id === 'android' ? '05d57804ca3f37a4d5366e4a44726a251e7f9e360fd804e40ffbdb4967b9dc00' : 'N/A',
