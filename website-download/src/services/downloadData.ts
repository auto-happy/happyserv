...
const versionData: Version[] = [
  ...platforms.map((p) => ({
    ...
    size: p.id === 'windows' ? '97.1 MB' : p.id === 'linux' ? '58.7 MB' : p.id === 'macos' ? '72.1 MB' : p.id === 'android' ? '32.5 MB' : '45.8 MB',
    sha256: '9d3c6c702033911f541aec1204eb671eb2729bab450630f27b0209fa61d7b0ab',
